...
public class EmbeddingService {
    ...
    public String askGpt(String userMessageStr, List<Embedding> embeddingList) throws Exception {
    ...
    private void generateChatGptEmbeddingsForChapter(String chapterId,String bookId) {
        ...
        content_list.forEach(microContent->{
            List<Double> embeddings = apiService.getEmbeddings(microContent);
    ...
    public List<EmbeddingResponseVO> getRelevantEmbeddingsContent(String inputText,String bookId){
